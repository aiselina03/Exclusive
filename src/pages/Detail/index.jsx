      ...
      <div className="detailContainer">
        <div className="detailPage">
          <div className="detailHead">
            <p>
              <span>Account / Gaming /</span> Havic HV G-92 Gamepad
            </p>
          </div>
          <div className="detail">
            ...
            <div className="info">
              ...
              <div className="star">
                ...
                <span className="comments">({products.comments} Reviews )</span>
                <span className="stock"> | In Stock</span>
              </div>
              <p className="price">${products.price}</p>
              <p className="desc">{products.description?.slice(0,310)}</p>
